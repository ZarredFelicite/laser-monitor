...
def run_brightness_tests():
    monitor = setup_brightness_monitor()
    ...
    for img_path in test_images:
        ...
        result_path = output_dir / f"{img_path.stem}_brightness_test_result.jpg"
    ...
    # Summary
    print(f"\n{'='*50}")
    print(f"BRIGHTNESS DETECTION TEST SUMMARY")
    print(f"{'='*50}")
...
if __name__ == "__main__":
    exit_code = run_brightness_tests()
    sys.exit(exit_code)